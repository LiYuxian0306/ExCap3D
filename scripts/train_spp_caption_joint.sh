...
python main_instance_segmentation.py \
    ...
    data.instance_classes_file=/cluster/eriador/cyeshwanth/scannetpp_download_v2_alpha/metadata/semantic_benchmark/top100_instance.txt \
    ...
    general.obj_caption_key=summarized_local_caption_16 \
    general.gen_part_captions=true \
    general.part_caption_key=summarized_parts_caption_16 \
